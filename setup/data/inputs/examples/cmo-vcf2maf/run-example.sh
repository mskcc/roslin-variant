...
#     --output-maf PoolTumor2-T_bc52_combined_variants.vep.maf \
#     --filter-vcf /ifs/work/chunj/prism-proto/ifs/depot/resources/vep/v86/ExAC_nonTCGA.r0.3.1.sites.vep.vcf.gz \
#     --input-vcf /ifs/work/chunj/prism-proto/ifs/prism/inputs/chunj/examples/data/from-module-4/PoolTumor2-T_bc52_combined_variants.vcf \
#     --species homo_sapiens

# cmo_vcf2maf --version 1.6.12 \
#     --output-maf PoolTumor2-T_bc52_combined_variants.vep.maf \
#     --input-vcf PoolTumor2-T_bc52_combined_variants.vcf \
#     --species homo_sapiens
