...
expression: "${ if (inputs.directory_list) { return {'output_directory':inputs.directory_list[0]}; } else { return { 'output_directory': {'class': 'Directory','basename': 'empty','listing': []} }}; }"