        ...
        for (final File fileEntry : imageFiles) {
            ...
            try{
                ...
                if(fname.endsWith("_trimmed_reads.pdf")){ 
                    ...
                    captionStr = "Capture Specificity: Average % selected on/near bait = " + Float.toString(this.qcSummary.getAverageOnNearBaitPercentage()) + "%. Average % on bait = " + Float.toString(this.qcSummary.getAverageOnBaitPercentage())  + "%. Average % on target = " + Float.toString(this.qcSummary.getAverageOnTargetPercentage()) + "%";
