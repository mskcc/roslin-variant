export ROSLIN_PIPELINE_DESCRIPTION="Roslin Variant Pipeline v1.0.0"
...
# cmo
export ROSLIN_CMO_VERSION="1.7.3"
export ROSLIN_CMO_BIN_PATH="/ifs/work/pi/cmo_package_archive/1.7.3/bin"
export ROSLIN_CMO_PYTHON_PATH="/ifs/work/pi/cmo_package_archive/1.7.3/lib/python2.7/site-packages"