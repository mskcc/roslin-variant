export ROSLIN_PIPELINE_DESCRIPTION="Roslin Variant Pipeline"

# Roslin pipeline name/version
export ROSLIN_PIPELINE_NAME="variant"
export ROSLIN_PIPELINE_VERSION="1.3.4"
...
# cmo
export ROSLIN_CMO_VERSION="1.9.3"
export ROSLIN_CMO_BIN_PATH="/ifs/work/pi/cmo_package_archive/1.9.3/bin"
export ROSLIN_CMO_PYTHON_PATH="/ifs/work/pi/cmo_package_archive/1.9.3/lib/python2.7/site-packages"
