...
def main():
    ...
    # from : [cmo_picard, --cmd CollectAlignmentSummaryMetrics]
    # to   : [cmo_picard, --cmd, CollectAlignmentSummaryMetrics]
    cwl['baseCommand'] = ['cmo_picard', '--cmd', 'CollectAlignmentSummaryMetrics']
    #<--
