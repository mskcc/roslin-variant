...
logger = logging.getLogger("build_images_parallel_singularity_only")
logger.setLevel(logging.INFO)
log_file_handler = logging.FileHandler('build_images_parallel_singularity_only.log')
...
logger.addHandler(log_file_handlerlogger.addHandler(log_stream_handler)
...
def main():
    parser = argparse.ArgumentParser(description='build-images-parallel-singularity-only')
    parser.add_argument(
        '-t',
        action="store",
        dest="threads",
